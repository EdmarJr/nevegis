CREATE FUNCTION [SIGEVEN].[FC_FONETIZAR] (@STR VARCHAR(5000), @CONSULTA CHAR(1))
...
DECLARE
  ...
  SELECT @STR = SIGEVEN.FC_REMOVER_ACENTO(@STR)

  /*********************************************/
  IF @STR = ' H '
     SET @STR = ' AGA '

  SELECT @STR = SIGEVEN.FC_SOMENTE_LETRAS(@STR)
  ...
  BEGIN
     ...
     IF @FONETIZAR = '1'
     BEGIN
        SELECT @PARTICULA = SIGEVEN.FC_FONETIZAR_PARTICULA(@PARTICULA)
