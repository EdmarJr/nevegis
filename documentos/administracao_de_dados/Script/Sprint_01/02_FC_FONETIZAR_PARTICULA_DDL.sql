CREATE FUNCTION [SIGEVEN].[FC_FONETIZAR_PARTICULA] (@STR VARCHAR(5000))
...
BEGIN
  ...
  SELECT @AUX = SIGEVEN.FC_SUBSTITUIR_TERMINACAO(@AUX)
  ...
  SELECT @AUX = SIGEVEN.FC_TRATAR_CONSOANTE_MUDA(@AUX,'B','I')
  SELECT @AUX = SIGEVEN.FC_TRATAR_CONSOANTE_MUDA(@AUX,'D','I')
  SELECT @AUX = SIGEVEN.FC_TRATAR_CONSOANTE_MUDA(@AUX,'P','I')
